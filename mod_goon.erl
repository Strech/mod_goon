%%%----------------------------------------------------------------------
%%% File    : mod_goon.erl
%%% Author  : Sergey Fedorov <oni.strech@gmail.com>
%%% Purpose : Support XEP-0199 XMPP Ping and periodic keepalives
%%% Created : 18 May 2013 by Sergey Fedorov <oni.strech@gmail.com>
%%%
%%%
...
-define(DEFAULT_ACTION_DELAY, 32000). % mseconds
...
init([Host, Opts]) ->
    ...
    ActionDelay = gen_mod:get_opt(action_delay, Opts, ?DEFAULT_ACTION_DELAY),
...
handle_info({timeout, _TRef, {ping, JID}}, State) ->
    ...
    ejabberd_local:route_iq(From, JID, IQ, F, State#state.action_delay),
    Timers = add_timer(JID, State#state.ping_interval, State#state.timers),
    {noreply, State#state{timers = Timers}};
